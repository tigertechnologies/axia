...
const wrap: React.CSSProperties = { maxWidth: 760, margin: "0 auto", padding: "56px 22px 80px", fontFamily: "'Inter',sans-serif", color:"var(--ink)", lineHeight: 1.65 };
const h1: React.CSSProperties = { fontFamily: "'Sora',sans-serif", fontSize: 30, color:"var(--ink)", fontWeight: 600, marginBottom: 6 };
const h2: React.CSSProperties = { fontFamily: "'Sora',sans-serif", fontSize: 19, color:"var(--ink)", fontWeight: 600, margin: "28px 0 8px" };
...
export default function Privacidade() {
  return (
    <main style={wrap}>
      ...
      <p style={{ color:"var(--muted)", fontSize: 13 }}>Versão preliminar, sujeita a revisão jurídica antes do lançamento comercial.</p>
      ...
      <p style={{ ...p, marginTop: 24, color:"var(--muted)", fontSize: 13 }}>A AXIA não substitui os sistemas oficiais dos tribunais. Datas e classificações são sugestões que exigem validação profissional.</p>
    </main>
  );
}
