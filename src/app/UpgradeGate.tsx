...
export default function UpgradeGate({ titulo, plano }: { titulo: string; plano: "Pro" | "Master" }) {
  return (
    <div style={{ maxWidth: 560, margin: "40px auto", textAlign: "center", padding: "40px 22px", background: "#fff", border: "1px solid #E6EBF2", borderRadius: 18 }}>
      <div style={{ width: 56, height: 56, borderRadius: 14, background: "#EEF3F9", display: "grid", placeItems: "center", margin: "0 auto 16px" }}>
      ...
      <h1 style={{ fontFamily: "'Sora',sans-serif", fontSize: 22, color: "#10233F", fontWeight: 600, marginBottom: 8 }}>{titulo} está no plano {plano}</h1>
      <p style={{ color: "#6B7C93", fontSize: 15, marginBottom: 22, lineHeight: 1.6 }}>
