...
const wrap = { maxWidth: 760, margin: "0 auto", padding: "56px 22px 80px", fontFamily: "'Inter',sans-serif", color:"var(--ink)", lineHeight: 1.65 } as React.CSSProperties;
const h1 = { fontFamily: "'Sora',sans-serif", fontSize: 30, color:"var(--ink)", fontWeight: 600, marginBottom: 6 } as React.CSSProperties;
const h2 = { fontFamily: "'Sora',sans-serif", fontSize: 19, color:"var(--ink)", fontWeight: 600, margin: "28px 0 8px" } as React.CSSProperties;
