    ...
    <>
      ...
      <section className="hero" id="top">
        ...
        <div className="wrap hero-grid">
          <div className="hero-copy reveal">
            <span className="eyebrow">{t("hero_eyebrow", "Inteligência que conecta o que importa")}</span>
            <h1>{t("hero_title", "Você não precisa mais procurar")}<span className="accent">{t("hero_title_accent", "o que é importante.")}</span></h1>
            <p className="sub">{t("hero_sub", "Conecte seu e-mail e deixe a AXIA identificar automaticamente nomeações, intimações, prazos, perícias e outras comunicações da sua rotina pericial.")}</p>
            <div className="hero-actions">
              <a className="btn btn-primary" href="#planos">{t("hero_cta_primary", "Começar agora")}
              ...
              <a className="btn btn-ghost" href="#como">{t("hero_cta_secondary", "Ver como funciona")}</a>
            </div>
            <div className="hero-trust"><span className="dot" /> {t("hero_trust", "Conexão segura • Criptografia • Conformidade com a LGPD")}</div>
          </div>
      ...
      <div className="strip">
        <div className="wrap reveal">
          <p className="cap">{t("features_cap", "Tudo que importa, já separado")}</p>
          <div className="chips">
