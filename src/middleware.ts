...
const PROTECTED = ["/dashboard", "/jornada", "/laudos", "/calculos", "/relatorios", "/admin", "/busca", "/inbox", "/nomeacoes", "/prazos", "/pericias", "/processos", "/honorarios", "/agenda", "/onboarding", "/configuracoes"];
...
export const config = {
  matcher: [
    "/dashboard/:path*", "/jornada/:path*", "/laudos/:path*", "/calculos/:path*", "/relatorios/:path*", "/admin/:path*", "/busca/:path*", "/inbox/:path*", "/nomeacoes/:path*", "/prazos/:path*",
